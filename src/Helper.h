...
namespace Inf
{
    ...
    {
        /**
         * We need this to be able to pass strings as Template parameters. There will probably be a more supported way in
         * C++23. See https://www.quora.com/How-do-you-pass-a-string-literal-as-a-parameter-to-a-C-template-class.
         */
        template<size_t N>
        struct FixedString
        {
