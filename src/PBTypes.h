...
namespace Inf
{
	...
	// Need to be classes because functions cant partially specialized
	template <typename T, pblong... dims>
	class Type<PBArray<T, dims...>>
	{
	public:
	...
	class Type<PBArray<PBObject<cls_name, group_type>, dims...>>
	{
	public:
		static inline bool Assert(IPB_Session* session, IPB_Value* pb_value)
		{
	...
	class Type<PBObject<cls_name, group_type>>
	{
	public:
