...
INF_REGISTER_FUNC(SetPBLongPtr , L"of_setp", L"aa_to", L"aa_from");
...
INF_REGISTER_FUNC(GetPBLongPtr , L"of_getp", L"aa_x");
...
void Inf::FrameworkTester::SetAny(PBAny& x, PBAny y)
{
    ...
    case Type<PBLongPtr >::PBType: x = PBAny(m_Session, y.Get<PBLongPtr >()); break;
...
Inf::PBAny Inf::FrameworkTester::GetAny(PBAny x)
{
    ...
    case Type<PBLongPtr >::PBType: return PBAny(m_Session, x.Get<PBLongPtr >());
...
void Inf::FrameworkTester::SetField(PBObject<L"u_pbni_test_object">& x, PBAny y)
{
    ...
    case Type<PBLongPtr >::PBType: x.SetField(L"ilp_test", y.Get<PBLongPtr >()); break;
...
Inf::PBAny Inf::FrameworkTester::GetField(PBObject<L"u_pbni_test_object"> x, PBInt y)
{
    ...
    case  9: return PBAny(m_Session, x.GetField<PBLongPtr     >(L"ilp_test"));
    case 10: return PBAny(m_Session, x.GetField<PBReal        >(L"ir_test" ));
    case 11: return PBAny(m_Session, x.GetField<PBDouble      >(L"ido_test"));
    case 12: return PBAny(m_Session, x.GetField<PBDecimal     >(L"ide_test"));
    case 13: return PBAny(m_Session, x.GetField<PBTime        >(L"it_test" ));
    case 14: return PBAny(m_Session, x.GetField<PBDate        >(L"ida_test"));
    case 15: return PBAny(m_Session, x.GetField<PBDateTime    >(L"idt_test"));
    case 16: return PBAny(m_Session, x.GetField<PBString      >(L"is_test" ));
    case 17: return PBAny(m_Session, x.GetField<PBBlob        >(L"ibl_test"));
    case 18: return PBAny(m_Session, x.GetField<DynPBObject   >(L"iu_test" ));
    case 19: return PBAny(m_Session, x.GetField<PBArray<PBAny>>(L"ia_test" )); // TODO add this to pb test cases
    default: throw PBNI_Exception(L"Not implemented");
    }
}
...
void Inf::FrameworkTester::SetterField(PBObject<L"u_pbni_test_object">& x, PBAny y)
{
    ...
    case Type<PBLongPtr >::PBType: x.Call(L"of_set_ilp", y.Get<PBLongPtr >()); break;
...
Inf::PBAny Inf::FrameworkTester::GetterField(PBObject<L"u_pbni_test_object"> x, PBInt y)
{
    ...
    case  9: return PBAny(m_Session, x.Call<PBLongPtr  >(L"of_get_ilp"));
    case 10: return PBAny(m_Session, x.Call<PBReal     >(L"of_get_ir" ));
    case 11: return PBAny(m_Session, x.Call<PBDouble   >(L"of_get_ido"));
    case 12: return PBAny(m_Session, x.Call<PBDecimal  >(L"of_get_ide"));
    case 13: return PBAny(m_Session, x.Call<PBTime     >(L"of_get_it" ));
    case 14: return PBAny(m_Session, x.Call<PBDate     >(L"of_get_ida"));
    case 15: return PBAny(m_Session, x.Call<PBDateTime >(L"of_get_idt"));
    case 16: return PBAny(m_Session, x.Call<PBString   >(L"of_get_is" ));
    case 17: return PBAny(m_Session, x.Call<PBBlob     >(L"of_get_ibl"));
    case 18: return PBAny(m_Session, x.Call<DynPBObject>(L"of_get_iu" ));
    default: throw PBNI_Exception(L"Not implemented");
    }
}
...
void Inf::FrameworkTester::GetterRefField(PBObject<L"u_pbni_test_object"> x, PBInt y, PBAny& z)
{
    ...
    case  9: x.Call<void, PBAny&>(L"of_get_ilp", z); break;
    case 10: x.Call<void, PBAny&>(L"of_get_ir" , z); break;
    case 11: x.Call<void, PBAny&>(L"of_get_ido", z); break;
    case 12: x.Call<void, PBAny&>(L"of_get_ide", z); break;
    case 13: x.Call<void, PBAny&>(L"of_get_it" , z); break;
    case 14: x.Call<void, PBAny&>(L"of_get_ida", z); break;
    case 15: x.Call<void, PBAny&>(L"of_get_idt", z); break;
    case 16: x.Call<void, PBAny&>(L"of_get_is" , z); break;
    case 17: x.Call<void, PBAny&>(L"of_get_ibl", z); break;
    case 18: x.Call<void, PBAny&>(L"of_get_iu" , z); break;
    case 19: x.Call<void, PBAny&>(L"of_get_ia" , z); break; // TODO add to pb side
    default: throw PBNI_Exception(L"Not implemented");
    }
}
...
void Inf::FrameworkTester::SetArray(PBArray<PBAny>& x, PBAny y)
{
    ...
    case Type<PBLongPtr >::PBType: SetArrayHelper<PBLongPtr  >(x, y); break;
...
Inf::PBAny Inf::FrameworkTester::GetArray(PBAny x)
{
    ...
    case Type<PBLongPtr >::PBType: return GetArrayHelper<PBLongPtr >(x);
